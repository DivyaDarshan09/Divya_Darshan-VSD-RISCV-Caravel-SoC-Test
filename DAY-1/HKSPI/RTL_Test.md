# Caravel SoC HKSPI Verification

<div align="center">

<span style="padding:10px 18px;border-radius:12px;background:#000;color:#ff7f50;font-size:18px;box-shadow:0 0 12px #ff7f50;">
🔥 VSD – IIT Gandhinagar
</span>

<span style="padding:10px 18px;border-radius:12px;background:#000;color:#9b59b6;font-size:18px;box-shadow:0 0 12px #9b59b6;">
⚡ Caravel SoC
</span>

<span style="padding:10px 18px;border-radius:12px;background:#000;color:#2ecc71;font-size:18px;box-shadow:0 0 12px #2ecc71;">
🧪 RTL & GLS Simulation
</span>

<span style="padding:10px 18px;border-radius:12px;background:#000;color:#f1c40f;font-size:18px;box-shadow:0 0 12px #f1c40f;">
📅 Day 1
</span>
